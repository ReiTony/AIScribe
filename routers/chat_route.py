...
async def chat_endpoint(
    ...
    try:
            ...
            if should_continue_form_filling:
                ...
                for section_name, section_schema in flow_steps:
                    if section_name not in all_collected_data:
                        ...
                        break
                    is_complete, missing_fields = is_section_complete(section_schema, all_collected_data.get(section_name, {}))
                    if not is_complete:
        ...
        if current_doc_type_for_response and final_collected_data_nested:
            aliased_collected_data = convert_to_aliased_json(current_doc_type_for_response, final_collected_data_nested)
